  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 text-sm leading-relaxed">
      ...
      <section className="mb-8">
        ...
        <ul className="mb-3 list-disc space-y-2 pl-5 text-muted-foreground">
          ...
          <li>
            ...
            kezdetén tájékoztatni kell. (A VRGO jelenlegi nyilvános oldala nem
            üzemeltet ügyfélchatbotot.)
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-3 text-muted-foreground">
          A VRGO stratégiája: a közzétett üzleti szövegeket lehetőség szerint emberi
          szerkesztéssel véglegesítjük; ahol ez nem történt meg, vagy szintetikus
          média deepfake-kritériumoknak felel meg, látható jelölést alkalmazunk.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-3 text-muted-foreground">
          A főoldali szolgáltatás- és csomagleírások célja a saját, emberi
          szerkesztésű / régi VRGO forrásanyagok visszaállítása; ahol AI-vázlat
          maradt, azt emberi szerkesztői felelősség mellett{" "}
          <em>assisted</em> kategóriába soroljuk.
        </p>
      </section>
