...
export const metadata: Metadata = {
  ...
  description:
    "A VRGO adatkezelési tájékoztatója — GDPR szerinti tájékoztatás a kapcsolatfelvételhez és elektronikus ügymenetéhez szükséges adatokról.",
};
...
const SECTIONS = [
  ...
  {
    title: "6. Adattovábbítás, adatfeldolgozók",
    body: [
      "Személyes adatot csak a szolgáltatás nyújtásához szükséges mértékben, megbízható adatfeldolgozók (pl. tárhely, e-mail) felé továbbítunk, szerződéses garanciák mellett.",
      "Harmadik országba történő adattovábbítás csak megfelelő garanciák (pl. megfelelőségi határozat / standard szerződéses klauzulák) mellett történhet.",
    ],
  },
  {
    ...
    body: [
      ...
      "A beleegyezést a böngésző localStorage-jában tároljuk (vrgo-gdpr-consent), hogy ne kelljen minden alkalommal újra megjeleníteni a sávot.",
      "A partner- és admin belépéshez szükséges munkamenet-cookie-k a szolgáltatás működéséhez kellenek.",
    ],
  },
  {
